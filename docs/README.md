...
Keep active documentation concise and current. Historical detail belongs in Git history unless it is needed to operate the workaround safely.

The repository currently has no `context/`, `docs/archive/`, or `docs/report/` directories. If they are added later, treat `context/raw/`, `docs/archive/`, and `docs/report/` as historical/raw material rather than first-read documentation.
